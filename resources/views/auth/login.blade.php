...
<body class="bg-indigo-900 text-white min-h-screen flex items-center justify-center p-6">
    <div class="max-w-md w-full bg-white text-slate-900 rounded-[2rem] p-8 shadow-2xl">
        ...
        <div class="my-6 flex items-center justify-between text-slate-350">
            <span class="w-1/4 border-b"></span>
            <span class="text-xs uppercase font-bold text-slate-400">atau</span>
            <span class="w-1/4 border-b"></span>
        </div>

        <a href="{{ route('auth.google') }}" class="w-full py-4 bg-white border-2 border-slate-200 text-slate-700 rounded-2xl font-bold text-md flex items-center justify-center gap-3 hover:bg-slate-50 transition shadow-sm">
