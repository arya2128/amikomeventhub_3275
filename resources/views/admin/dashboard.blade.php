...
@section('page_subtitle', 'Pantau performa penjualan tiket dan event Anda di sini.')
            ...
            <tbody class="divide-y border-t">
                ...
                <tr class="hover:bg-slate-50 transition">
                    <td class="px-8 py-6 text-sm text-slate-600 max-w-xs break-all">
                        {{ $trx->created_at->format('d M Y - H:i') }} WIB<br>
                    ...
                    <td class="px-8 py-6 whitespace-nowrap">
                        @if(in_array(strtolower($trx->status), ['settlement', 'success', 'completed']))
