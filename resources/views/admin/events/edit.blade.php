            ...
            <div class="col-span-2">
                ...
                <div class="flex items-start gap-6 p-4 border border-dashed border-slate-200 rounded-2xl bg-slate-50/50">
                    <div class="shrink-0 text-center">
                        ...
                        <img src="{{ $event->poster_url }}" class="w-24 h-32 rounded-xl object-cover shadow-md border-2 border-white" onerror="this.onerror=null;this.src='/assets/concert.png';">
                    </div>
                    <div class="flex-1">
