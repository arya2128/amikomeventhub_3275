...
<script type="text/javascript">
    document.getElementById('pay-button').onclick = function () {
        ...
        @else
        // Fallback untuk keperluan testing/jika sandbox key belum diisi di .env
        console.log("Snap Token kosong, mengalihkan secara langsung ke halaman sukses untuk simulasi.");
        window.location.href = "{{ route('checkout.success', $transaction->order_id) }}";
        @endif
    };
